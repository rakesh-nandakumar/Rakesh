...
const TimelineCard = memo(function TimelineCard({ item, position, isActive }) {
  ...
  return (
    <div className="timeline-card">
      <div
        ref={cardRef}
        className={`rn-portfolio ${animationClass} ${isActive ? "animate-scale-up" : ""}`}
        style={{
          ...
          <div className="content">
            <div className="category-info">
              <div className="category-list">
                <span itemProp="eventAttendanceMode">{getCategoryLabel()}</span>
              </div>
              {(item.time || item.year) && (
                <div className="meta">
                  <time
            ...
            {item.technologies && item.technologies.length > 0 && (
              <div className="technologies" role="list" aria-label="Technologies used">
            ...
            {item.links && item.links.length > 0 && (
              <nav className="links-section" style={{ marginTop: "16px" }} aria-label="Related links">
