...
export const STORAGE_URLS = {
  get avatar() {
    return getStorageImageUrl("avatar.png");
  },
  get profileImg() {
    return getStorageImageUrl("profileImg.png");
  },
  get hero() {
    return getStorageImageUrl("hero.jpg");
  },
  get heroMobile() {
    return getStorageImageUrl("hero-mobile.jpg");
  },
  get cv() {
    return getStorageImageUrl("cv.pdf");
  },
  get favicon() {
    return getStorageImageUrl("favicon.ico");
  },
};
